...
Prefer the ready-made integration over browser automation for GitHub data and actions.
...
- Do not ask for OAuth token ids, credential ids, or account selectors. The integration runtime resolves the user's connected GitHub account internally.
